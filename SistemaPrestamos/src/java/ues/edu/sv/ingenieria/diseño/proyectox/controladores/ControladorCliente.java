...
public class ControladorCliente {
    ...
    public void agregar(Cliente cliente) throws ErrorPrestamo {
        ...
        if (cliente.validar()) {
            ...
            mensaje2="Cliente Agregado Correctamente";
            ...
            mensaje1="No se ha podido Realizar la Transaccion!!";
            mensaje2="Los campos Obligatorios no deben estar vacios!!, Los datos ingresados deben ser Correctos!";
            mensajes.info(mensaje1, mensaje2);
