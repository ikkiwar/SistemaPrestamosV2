...
public class ControladorPrestamo implements Serializable {
    ...
    public void agregar(Prestamo prestamo) throws ErrorPrestamo {
        ...
        if (controladorBalance.prestamoBalance(prestamo)==true) {
              
            try {

                mensaje1= "Transaccion Exitosa!!";
                mensaje2 ="Prestamo Agregado Correctamente!";
            ...
            mensaje1= "Algo ha fallado!!";
            mensaje2 ="El valor del Monto ha pretar es mayor que efectivo Disponible, Revise Efectivo en Balance";
