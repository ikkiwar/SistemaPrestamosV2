...
public class ControladorSesion {
  ...
  // metodo para comprar contraseñas la que se esta ingresando y la almacenda en la base de datos
    public boolean verificar(String login, String claveUsuario) throws ErrorPrestamo {
        ...
        ResultSet resultado;
        String claveComprobador = encrip.encriptar(claveUsuario);
// trae de la bd la contraseña encriptada almacenada 
        try {

            Conexion conexion = new Conexion();
            resultado = conexion.getValores("SELECT * FROM usuario WHERE login='" + login + "';");
