...
public class ControladorCliente {
    ...
    public void agregar(Cliente cliente) throws ErrorPrestamo {
        ...
        if (conexion != null) {
            conexion.UID("INSERT INTO cliente(dui,nit,nombres,apellidos,sexo,direccion,telefonos,fecha_nacimiento,observaciones) VALUES('" + cliente.getDui() + "','" + cliente.getNit() + "','" + cliente.getNombres() + "', '" + cliente.getApellidos() + "','" + cliente.getSexo() + "','" + cliente.getDireccion() + "','" + cliente.getTelefono() + "','" + fecha + "','" + cliente.getObservaciones() + "')");
    ...
    public void actualizar(Cliente cliente) throws ErrorPrestamo{
        ...
        try {
            Conexion conexion = new Conexion();
            conexion.UID("UPDATE cliente SET nit='" + cliente.getNit() + "',nombres='" + cliente.getNombres() +"',apellidos='"+cliente.getApellidos()+"',sexo='"+cliente.getSexo()+"',direccion='"+cliente.getDireccion()+"',telefonos='"+cliente.getTelefono()+"',fecha_nacimiento='"+fecha+"',observaciones='"+cliente.getObservaciones()+"' WHERE dui='" + cliente.getDui() + "'");
        } catch (Exception e) {
    ...
    public List<Cliente> obtener() throws ErrorPrestamo {
        ...
        try {
            ...
            while (resultado.next()) {
                clientes.add(new Cliente(resultado.getString("dui"), resultado.getString("nit"), resultado.getString("nombres"), resultado.getString("apellidos"), resultado.getString("sexo").charAt(0), resultado.getString("direccion"), resultado.getString("telefonos"), resultado.getDate("fecha_nacimiento"), resultado.getString("observaciones")));
    ...
    public List<Cliente> buscar(String filtro) throws ErrorPrestamo {
        ...
        try {
            ...
            resultado = conexion.getValores("SELECT * FROM cliente  WHERE  nombres LIKE '" + filtro + "%' OR apellidos LIKE '" + filtro + "%'");
            while (resultado.next()) {
                clientes.add(new Cliente(resultado.getString("dui"), resultado.getString("nit"), resultado.getString("nombres"), resultado.getString("apellidos"), resultado.getString("sexo").charAt(0), resultado.getString("direccion"), resultado.getString("telefonos"), resultado.getDate("fecha_nacimiento"), resultado.getString("observaciones")));
